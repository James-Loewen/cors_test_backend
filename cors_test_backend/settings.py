"""
Django settings for cors_test_backend project.
...
SECRET_KEY = "django-insecure-snwg#ci89*9#kkwf4j%@ieg)%=s9pj4=j8etmr45i7s17@%uw!"
...
ROOT_URLCONF = "cors_test_backend.urls"
...
WSGI_APPLICATION = "cors_test_backend.wsgi.application"
